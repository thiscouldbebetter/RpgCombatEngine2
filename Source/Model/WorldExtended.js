...
class WorldExtended extends World {
    constructor() {
        ...
        var partyPlayer = new Party("Player", partyPlayerAgents, partyPlayerItems);
        var partyEnemy = new Party("Enemy", [
            new Agent(null, // name
        ...
        var place = new PlaceEncounter(PlaceEncounter.name + "0", partyPlayer, partyEnemy);
        var places = [place];
        var placesByName = ArrayHelper.addLookupsByName(places);
        super("RpgCombatEngine", DateTime.now(), placeDefn, (placeName) => placesByName.get(placeName), PlaceEncounter.name + "0" // placeInitialName
        );
    }
    static defnBuild() {
